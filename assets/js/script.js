...
const photoModalNote = document.querySelector('[data-photo-modal-note]');
...
const renderPhotoModal = () => {
  ...
  if (photoModalTime) {
    const timeLabel = currentPhoto.dataset.photoTimeLabel || 'Photo time';
    photoModalTime.textContent = currentPhoto.dataset.photoTime ? `${timeLabel}: ${currentPhoto.dataset.photoTime}` : '';
    photoModalTime.hidden = !currentPhoto.dataset.photoTime;
  }

  if (photoModalPlace) {
    photoModalPlace.textContent = currentPhoto.dataset.photoPlace ? `Place: ${currentPhoto.dataset.photoPlace}` : '';
    photoModalPlace.hidden = !currentPhoto.dataset.photoPlace;
  }

  if (photoModalNote) {
    photoModalNote.textContent = currentPhoto.dataset.photoNote || '';
    photoModalNote.hidden = !currentPhoto.dataset.photoNote;
  }
